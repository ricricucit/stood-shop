...
const HtmlWebpackHarddiskPlugin = require('html-webpack-harddisk-plugin'); //to save on disk when running webpack-dev-server

const mainJSPath = path.resolve(__dirname, 'src/js', 'main.js');
const mainCSSPath = path.resolve(__dirname, 'src/sass', 'main.scss');
const publicPath = path.resolve(__dirname, 'dist/assets');
...
const prod_plugins = [
      ...
      { from: imagesPath + '/', to: 'images' }, { from: './src/fonts/', to: 'fonts' }
    ]),
